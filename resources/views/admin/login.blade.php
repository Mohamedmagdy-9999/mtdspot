...
<!-- Mirrored from laravel8.spruko.com/noa/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 09:13:49 GMT -->
				...
				<div>
					...
					<div class="col col-login mx-auto text-center">
						<a href="index.html" class="text-center">
							<img src="{{asset('admin/assets/images/capital.jpg')}}" class="header-brand-img" alt="">
						</a>
					</div>
					<div class="container-login100">
						<div class="wrap-login100 p-0">
							<div class="card-body">
								<form class="login100-form validate-form" action="{{route('log')}}" method="POST">
                                    @csrf
