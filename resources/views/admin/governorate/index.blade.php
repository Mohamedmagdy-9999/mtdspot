                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                ...
                                <div class="ms-auto pageheader-btn">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">{{trans('main.governorates')}}</a></li>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>{{ $item->name_en}}</td>
                                                                                                ...
                                                                                                <td style="text-align: center;">
                                                                                                    ...
                                                                                                    <a href="{{route('admin.governorate.edit',$item->id)}}" class="btn btn-success">{{trans('main.edit')}}</a>
