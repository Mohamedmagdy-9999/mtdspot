                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                ...
                                <div class="ms-auto pageheader-btn">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">{{trans('main.governorate')}} {{$item->name_ar}}</a></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="{{route('admin.governorate.update',$item->id)}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
