                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                ...
                                <div class="ms-auto pageheader-btn">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">{{trans('main.edit_category')}} {{$category->name_ar}}</a></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <img src="{{asset('categories/'.$category->image)}}" style="width:300px;" alt="">
                                                    <br>
                                                    <br>
