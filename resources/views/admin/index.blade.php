                    ...
                    <div class="card bg-primary overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="col">
                                <div class="row">
                                <div class="col-6">
                                    <h2 class="mb-2 fw-semibold">Total Users</h2>
                                </div>
                                <div class="col-6">
                ...
                <div class="col-lg-3 col-sm-12 col-md-3 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                {{-- <div class="col">
                                   <h4 class="mb-2 fw-semibold"># of Books Sales </h4>
                                    @php
                                        $books = App\Models\UserOrder::where('book_id', '!=', null)->count();
                                    
                                    @endphp
                                    <h3 class="mb-2 fw-semibold">{{$books}} Books</h3> 
                                </div> --}}
                                <div class="col col-auto top-icn dash">
