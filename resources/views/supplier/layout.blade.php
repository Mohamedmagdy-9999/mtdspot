                        ...
                        <div class="d-flex">
                            ...
                            <div class="extra-cell" style="margin:30px;">
                                @if (app()->isLocale('en'))
                                    ...
                                    <a href="{{ route('supplier.switch_language', 'ar') }}">

                                        <i class="fa fa-language"></i> Arabic
                                    </a>
                                @else
                                    <a href="{{ route('supplier.switch_language', 'en') }}">
                                            ...
                                            <div class="dropdown d-md-flex profile-1">
                                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                                        ...
                                                        <div class="text-center p-1 d-flex d-lg-none-max">
                                                            ...
                                                            <h6 class="mb-0" id="profile-heading">{{auth('supplier')->user()->name}}<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                                        </div>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                    ...
                                                    <form action="{{route('supplier.logout_supplier')}}" method="POST">
                                                        @csrf
                    ...
                    <div class="app-sidebar">
                        ...
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('supplier.dashboard')}}">
                                    ...
                                    <li class="slide">
                                        ...
                                        <ul class="slide-menu">
                                            <li class="side-menu-label1"><a href="javascript:void(0)">Tables</a></li>
                                             <li><a href="{{route('supplier.supplier_order_products')}}" class="slide-item">{{trans('main.orders')}}</a></li> 
