<div>
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editCategoryModal" wire:click="editCategory({{ $category->id }})">
                                                                           edit
                                                                        </button>

                                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal" wire:click="deleteConfirmation({{ $category->id }})">
                                                                            delete
                                                                        </button>
    ...
    <div wire:ignore.self class="modal fade" id="editCategoryModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
